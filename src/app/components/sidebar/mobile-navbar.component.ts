  ...
  template: `
      <div class="navbar fixed w-screen backdrop-blur-md p-3.5 flex flex-col justify-between"
          ...
          <div class="flex flex-row justify-around items-center">
              ...
              <img class="rounded-full" width="28" height="28" [ngSrc]="getProfileImage()" (click)="toggleProfile()" alt="profile" priority>
          </div>
      </div>
  `,
  styles: [`
...
export class MobileNavbarComponent implements OnInit{
  ...
  getProfileImage() {
    ...
    return this.profile()!.avatarUrl ? this.profile()!.avatarUrl! : `https://eu.ui-avatars.com/api/?name=${this.profile()?.username}&rounded=true&size=28`;
  }
